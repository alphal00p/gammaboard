...
common_export="ALL,GAMMABOARD_IMAGE=${IMAGE_PATH},GAMMABOARD_WORKSPACE_ROOT=${WORKSPACE_ROOT},GAMMABOARD_PROJECT_ROOT=${WORKSPACE_ROOT},GAMMABOARD_DATABASE_URL=${DATABASE_URL},NODE_PREFIX=${NODE_PREFIX},DEPLOY_NAME=${DEPLOY_NAME}"
