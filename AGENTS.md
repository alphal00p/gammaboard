...
- Scalar and complex accumulator display projections, including named discrete histograms and their normalization mode, belong to the effective accumulator config and are inherited with that accumulator state.
