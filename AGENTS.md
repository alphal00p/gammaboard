...
- Backend panel specs may carry simple layout hints such as compact/half/full width; prefer backend-owned placement intent over frontend kind-based guesses.
