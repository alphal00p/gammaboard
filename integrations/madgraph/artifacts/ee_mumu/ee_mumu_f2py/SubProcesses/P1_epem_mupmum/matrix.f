...
C     
C     Process: _anti_lepton _lepton > _anti_lepton _lepton WEIGHTED<=4
C      @1
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL IXXXXX(P(0,3),ZERO,NHEL(3),-1, FLAVOR(3),W(3))
      CALL OXXXXX(P(0,4),ZERO,NHEL(4),+1, FLAVOR(4),W(4))
      CALL FFV1P0_3(W(2),W(1),GC_3,ZERO,ZERO,W(5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(3),W(4),W(5),GC_3,AMP(1))
      CALL FFV6_2_3(W(2),W(1),GC_FFV_2,GC_FFV_3,MDL_MZ,MDL_WZ,W(5))
C     Amplitude(s) for diagram number 2
      CALL FFV6_2_0(W(3),W(4),W(5),GC_FFV_2,GC_FFV_3,AMP(2))
