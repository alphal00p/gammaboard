use crate::config::LocalPostgresConfig;
...
pub fn reset_db(local: &LocalPostgresConfig, assume_yes: bool, database_url: &str) -> Result<()> {
    delete_db(local, assume_yes)?;
    start_db(local, database_url)?;
    Ok(())
}

pub fn status_db(local: &LocalPostgresConfig, database_url: &str) -> Result<()> {
...
pub fn start_db(local: &LocalPostgresConfig, database_url: &str) -> Result<()> {
...
pub fn start_postgres_cluster(local: &LocalPostgresConfig, database_url: &str) -> Result<()> {
...
pub fn stop_db(local: &LocalPostgresConfig) -> Result<()> {
