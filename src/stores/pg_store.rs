...
use crate::core::{
    ...
    RunStageSnapshot, RunTask, RunTaskInput, RunTaskStore, SamplerAggregatorPerformanceSnapshot,
...
impl RunTaskStore for PgStore {
    ...
    async fn persist_task_measurement_output(
        ...
        queries::persist_task_measurement_output(&self.pool, task_id, output)
            .await
            .map_err(map_sqlx)
    }
